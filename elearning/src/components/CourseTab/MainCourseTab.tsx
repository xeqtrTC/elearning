...
import { AllCourseDetailsArray, courseArray, coursesForUserProps } from "../Hooks/interfaces";
import { Link } from "react-router-dom";

const MainCourseTab = ({ course_id, createdAt, description, imageLink, levelOfCourse, title, updatedAt, instructors, lessons }: AllCourseDetailsArray) => {
    return (
        <div className=" p-3">
            <div className=" shadow-xl">
                ...
                <div className="p-5 space-y-3">
                    ...
                    <div className="flex text-white justify-center space-x-2">
                        <button className="bg-[#0E111E] w-[50%] py-2 font-medium rounded-lg">COURSE VIDEOS</button>
                    </div>
                </div>
            </div>
        </div>
